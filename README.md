...
react-lib-scripts/0.0.4 darwin-x64 node-v8.11.2
...
_See code: [src/commands/build.js](https://github.com/antonybudianto/react-lib-scripts/blob/v0.0.4/src/commands/build.js)_
...
_See code: [src/commands/start.js](https://github.com/antonybudianto/react-lib-scripts/blob/v0.0.4/src/commands/start.js)_
<!-- commandsstop -->
