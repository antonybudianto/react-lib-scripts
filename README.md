...
_See code: [src/commands/build.js](https://github.com/antonybudianto/react-lib-scripts/blob/v0.0.15/src/commands/build.js)_
...
_See code: [src/commands/start.js](https://github.com/antonybudianto/react-lib-scripts/blob/v0.0.15/src/commands/start.js)_
<!-- commandsstop -->
# Customize
- Babel
